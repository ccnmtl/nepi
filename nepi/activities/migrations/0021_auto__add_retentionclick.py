...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RetentionClick'
        db.create_table(u'activities_retentionclick', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('click_string', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'activities', ['RetentionClick'])


    def backwards(self, orm):
        # Deleting model 'RetentionClick'
        db.delete_table(u'activities_retentionclick')
