...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdherenceCard.intro_text'
        db.delete_column(u'activities_adherencecard', 'intro_text')


    def backwards(self, orm):
        # Adding field 'AdherenceCard.intro_text'
        db.add_column(u'activities_adherencecard', 'intro_text',
