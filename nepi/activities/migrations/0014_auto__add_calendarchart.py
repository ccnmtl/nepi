...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarChart'
        db.create_table(u'activities_calendarchart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
            ('birth_date', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'activities', ['CalendarChart'])


    def backwards(self, orm):
        # Deleting model 'CalendarChart'
        db.delete_table(u'activities_calendarchart')
