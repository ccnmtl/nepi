...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RetentionRateCard'
        db.create_table(u'activities_retentionratecard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('intro_text', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'activities', ['RetentionRateCard'])


    def backwards(self, orm):
        # Deleting model 'RetentionRateCard'
        db.delete_table(u'activities_retentionratecard')
