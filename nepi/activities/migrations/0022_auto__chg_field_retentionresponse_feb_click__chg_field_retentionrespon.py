...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RetentionResponse.feb_click'
        db.alter_column(u'activities_retentionresponse', 'feb_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.mar_click'
        db.alter_column(u'activities_retentionresponse', 'mar_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.delivery_date_click'
        db.alter_column(u'activities_retentionresponse', 'delivery_date_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.cohort_click'
        db.alter_column(u'activities_retentionresponse', 'cohort_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.apr_click'
        db.alter_column(u'activities_retentionresponse', 'apr_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.start_date_click'
        db.alter_column(u'activities_retentionresponse', 'start_date_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.may_click'
        db.alter_column(u'activities_retentionresponse', 'may_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.dec_click'
        db.alter_column(u'activities_retentionresponse', 'dec_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.jun_click'
        db.alter_column(u'activities_retentionresponse', 'jun_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.eligible_click'
        db.alter_column(u'activities_retentionresponse', 'eligible_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

        # Changing field 'RetentionResponse.jan_click'
        db.alter_column(u'activities_retentionresponse', 'jan_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.RetentionClick']))

    def backwards(self, orm):

        # Changing field 'RetentionResponse.feb_click'
        db.alter_column(u'activities_retentionresponse', 'feb_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.mar_click'
        db.alter_column(u'activities_retentionresponse', 'mar_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.delivery_date_click'
        db.alter_column(u'activities_retentionresponse', 'delivery_date_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.cohort_click'
        db.alter_column(u'activities_retentionresponse', 'cohort_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.apr_click'
        db.alter_column(u'activities_retentionresponse', 'apr_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.start_date_click'
        db.alter_column(u'activities_retentionresponse', 'start_date_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.may_click'
        db.alter_column(u'activities_retentionresponse', 'may_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.dec_click'
        db.alter_column(u'activities_retentionresponse', 'dec_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.jun_click'
        db.alter_column(u'activities_retentionresponse', 'jun_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.eligible_click'
        db.alter_column(u'activities_retentionresponse', 'eligible_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))

        # Changing field 'RetentionResponse.jan_click'
        db.alter_column(u'activities_retentionresponse', 'jan_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))
