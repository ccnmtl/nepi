...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conversation.conversation_type'
        db.alter_column(u'activities_conversation', 'conversation_type', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Conversation.conversation_type'
        db.alter_column(u'activities_conversation', 'conversation_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        u'activities.conversation': {
            ...
            'conversation_type': ('django.db.models.fields.CharField', [], {'default': "'G'", 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
