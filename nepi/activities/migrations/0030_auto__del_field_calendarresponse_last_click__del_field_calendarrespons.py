...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalendarResponse.last_click'
        db.delete_column(u'activities_calendarresponse', 'last_click_id')

        # Deleting field 'CalendarResponse.conv_scen'
        db.delete_column(u'activities_calendarresponse', 'conv_scen_id')

        # Adding field 'CalendarResponse.calendar_activity'
        db.add_column(u'activities_calendarresponse', 'calendar_activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.CalendarChart'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CalendarResponse.correct_click'
        db.add_column(u'activities_calendarresponse', 'correct_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='correct_click', null=True, to=orm['activities.Day']),
                      keep_default=False)


        # Changing field 'CalendarResponse.first_click'
        db.alter_column(u'activities_calendarresponse', 'first_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.Day']))

    def backwards(self, orm):
        # Adding field 'CalendarResponse.last_click'
        db.add_column(u'activities_calendarresponse', 'last_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='calendar_last_click', null=True, to=orm['activities.ConvClick'], blank=True),
                      keep_default=False)

        # Adding field 'CalendarResponse.conv_scen'
        db.add_column(u'activities_calendarresponse', 'conv_scen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.CalendarChart'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CalendarResponse.calendar_activity'
        db.delete_column(u'activities_calendarresponse', 'calendar_activity_id')

        # Deleting field 'CalendarResponse.correct_click'
        db.delete_column(u'activities_calendarresponse', 'correct_click_id')


        # Changing field 'CalendarResponse.first_click'
        db.alter_column(u'activities_calendarresponse', 'first_click_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.ConvClick']))
