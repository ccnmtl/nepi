...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activities_convclick', (
            ...
            ('conversation',
                ...
                (to=orm['activities.Conversation'], null=True, blank=True)),
        ))
        ...
        db.add_column(u'activities_conversationresponse', 'conv_scen',
                      self.gf('django.db.models.fields.related.ForeignKey')
                      (to=orm['activities.ConversationScenario'],
        ...
        db.add_column(u'activities_conversationresponse', 'first_click',
                      self.gf('django.db.models.fields.related.ForeignKey')
                      (blank=True, related_name='first_click', null=True,
                       to=orm['activities.ConvClick']),
                      keep_default=False)

        # Adding field 'ConversationResponse.second_click'
        db.add_column(u'activities_conversationresponse', 'second_click',
                      self.gf('django.db.models.fields.related.ForeignKey')
                      (blank=True, related_name='second_click', null=True,
                       to=orm['activities.ConvClick']),
                      keep_default=False)
        ...
        db.add_column(u'activities_conversationresponse', 'last_click',
                      self.gf('django.db.models.fields.related.ForeignKey')
                      (blank=True, related_name='third_click', null=True,
                       to=orm['activities.ConvClick']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration."
                           + " 'ConversationResponse.conversation' and its values cannot be restored.")
    ...
    models = {
        ...
        u'activities.conversation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [],
                    {'primary_key': 'True'}),
            'scenario': ('django.db.models.fields.related.ForeignKey',
                         [], {'to': u"orm['activities.ConversationScenario']",
                              'null': 'True'}),
            'text_one': ('django.db.models.fields.CharField',
                         [], {'max_length': '255', 'null': 'True'}),
            'text_three': ('django.db.models.fields.CharField',
                           [], {'max_length': '255', 'null': 'True'}),
            'text_two': ('django.db.models.fields.CharField', [],
                         {'max_length': '255', 'null': 'True'})
        },
        u'activities.conversationresponse': {
            ...
            u'id': ('django.db.models.fields.AutoField',
                    [], {'primary_key': 'True'}),
            'last_click': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True',
