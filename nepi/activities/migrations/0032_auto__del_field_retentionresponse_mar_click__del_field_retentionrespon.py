...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RetentionResponse.mar_click'
        db.delete_column(u'activities_retentionresponse', 'mar_click_id')

        # Deleting field 'RetentionResponse.apr_click'
        db.delete_column(u'activities_retentionresponse', 'apr_click_id')

        # Deleting field 'RetentionResponse.feb_click'
        db.delete_column(u'activities_retentionresponse', 'feb_click_id')

        # Deleting field 'RetentionResponse.may_click'
        db.delete_column(u'activities_retentionresponse', 'may_click_id')

        # Deleting field 'RetentionResponse.dec_click'
        db.delete_column(u'activities_retentionresponse', 'dec_click_id')

        # Deleting field 'RetentionResponse.jun_click'
        db.delete_column(u'activities_retentionresponse', 'jun_click_id')

        # Deleting field 'RetentionResponse.jan_click'
        db.delete_column(u'activities_retentionresponse', 'jan_click_id')

        # Adding field 'RetentionResponse.follow_up_click'
        db.add_column(u'activities_retentionresponse', 'follow_up_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_follow_up_click', null=True, to=orm['activities.RetentionClick']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RetentionResponse.mar_click'
        db.add_column(u'activities_retentionresponse', 'mar_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_mar_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.apr_click'
        db.add_column(u'activities_retentionresponse', 'apr_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_apr_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.feb_click'
        db.add_column(u'activities_retentionresponse', 'feb_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_feb_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.may_click'
        db.add_column(u'activities_retentionresponse', 'may_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_may_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.dec_click'
        db.add_column(u'activities_retentionresponse', 'dec_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_dec_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.jun_click'
        db.add_column(u'activities_retentionresponse', 'jun_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_jun_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Adding field 'RetentionResponse.jan_click'
        db.add_column(u'activities_retentionresponse', 'jan_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='retention_jan_click', null=True, to=orm['activities.RetentionClick'], blank=True),
                      keep_default=False)

        # Deleting field 'RetentionResponse.follow_up_click'
        db.delete_column(u'activities_retentionresponse', 'follow_up_click_id')
    ...
    models = {
        ...
        u'activities.calendarresponse': {
            ...
            'calendar_activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.CalendarChart']", 'null': 'True', 'blank': 'True'}),
            'correct_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'correct_click'", 'null': 'True', 'to': u"orm['activities.Day']"}),
            'first_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'first_click'", 'null': 'True', 'to': u"orm['activities.Day']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'activities.day': {
            'Meta': {'ordering': "['number']", 'object_name': 'Day'},
        ...
        u'activities.dosageactivity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ml_nvp': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '4', 'decimal_places': '2'}),
        ...
        u'activities.retentionresponse': {
            ...
            'follow_up_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_follow_up_click'", 'null': 'True', 'to': u"orm['activities.RetentionClick']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
