...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarResponse'
        db.create_table(u'activities_calendarresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conv_scen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.CalendarChart'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('first_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='calendar_first_click', null=True, to=orm['activities.ConvClick'])),
            ('last_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='calendar_last_click', null=True, to=orm['activities.ConvClick'])),
        ))
        db.send_create_signal(u'activities', ['CalendarResponse'])

        # Adding model 'DosageActivity'
        db.create_table(u'activities_dosageactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('explanation', self.gf('django.db.models.fields.TextField')(default='')),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('ml_nvp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('times_day', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('weeks', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'activities', ['DosageActivity'])

        # Adding model 'DosageActivityResponse'
        db.create_table(u'activities_dosageactivityresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conv_scen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.DosageActivity'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('first_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dosage_first_click', null=True, to=orm['activities.ConvClick'])),
            ('last_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dosage_last_click', null=True, to=orm['activities.ConvClick'])),
        ))
        db.send_create_signal(u'activities', ['DosageActivityResponse'])


    def backwards(self, orm):
        # Deleting model 'CalendarResponse'
        db.delete_table(u'activities_calendarresponse')

        # Deleting model 'DosageActivity'
        db.delete_table(u'activities_dosageactivity')

        # Deleting model 'DosageActivityResponse'
        db.delete_table(u'activities_dosageactivityresponse')
    ...
    models = {
        ...
        u'activities.dosageactivityresponse': {
            ...
            'conv_scen': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.DosageActivity']", 'null': 'True', 'blank': 'True'}),
            'first_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dosage_first_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dosage_last_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        u'activities.imagemapchart': {
            'Meta': {'object_name': 'ImageMapChart'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_text': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['activities.ImageMapItem']", 'symmetrical': 'False'})
        },
        u'activities.imagemapitem': {
