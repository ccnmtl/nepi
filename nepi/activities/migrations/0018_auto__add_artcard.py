...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ARTCard'
        db.create_table(u'activities_artcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('intro_text', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'activities', ['ARTCard'])


    def backwards(self, orm):
        # Deleting model 'ARTCard'
        db.delete_table(u'activities_artcard')
