...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DosageActivityResponse.last_click'
        db.delete_column(u'activities_dosageactivityresponse', 'last_click_id')

        # Deleting field 'DosageActivityResponse.conv_scen'
        db.delete_column(u'activities_dosageactivityresponse', 'conv_scen_id')

        # Deleting field 'DosageActivityResponse.first_click'
        db.delete_column(u'activities_dosageactivityresponse', 'first_click_id')

        # Adding field 'DosageActivityResponse.dosage_activity'
        db.add_column(u'activities_dosageactivityresponse', 'dosage_activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.DosageActivity'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DosageActivityResponse.ml_nvp'
        db.add_column(u'activities_dosageactivityresponse', 'ml_nvp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DosageActivityResponse.times_day'
        db.add_column(u'activities_dosageactivityresponse', 'times_day',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DosageActivityResponse.weeks'
        db.add_column(u'activities_dosageactivityresponse', 'weeks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DosageActivityResponse.last_click'
        db.add_column(u'activities_dosageactivityresponse', 'last_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dosage_last_click', null=True, to=orm['activities.ConvClick'], blank=True),
                      keep_default=False)

        # Adding field 'DosageActivityResponse.conv_scen'
        db.add_column(u'activities_dosageactivityresponse', 'conv_scen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.DosageActivity'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DosageActivityResponse.first_click'
        db.add_column(u'activities_dosageactivityresponse', 'first_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dosage_first_click', null=True, to=orm['activities.ConvClick'], blank=True),
                      keep_default=False)

        # Deleting field 'DosageActivityResponse.dosage_activity'
        db.delete_column(u'activities_dosageactivityresponse', 'dosage_activity_id')

        # Deleting field 'DosageActivityResponse.ml_nvp'
        db.delete_column(u'activities_dosageactivityresponse', 'ml_nvp')

        # Deleting field 'DosageActivityResponse.times_day'
        db.delete_column(u'activities_dosageactivityresponse', 'times_day')

        # Deleting field 'DosageActivityResponse.weeks'
        db.delete_column(u'activities_dosageactivityresponse', 'weeks')
    ...
    models = {
        ...
        u'activities.dosageactivityresponse': {
            ...
            'dosage_activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.DosageActivity']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ml_nvp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'times_day': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
