...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Conversation.starting_conv'
        db.delete_column(u'activities_conversation', 'starting_conv')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'activities_conversation', 'scenario',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='conversations', null=True, to=orm['activities.ConversationScenario']),
                      keep_default=False)

        # Adding field 'Conversation.starting_conv'
        db.add_column(u'activities_conversation', 'starting_conv',
    ...
    models = {
        ...
        u'activities.conversationscenario': {
            ...
            'second_conversation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'second_conversation'", 'null': 'True', 'to': u"orm['activities.Conversation']"}),
            'starting_conv': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'first_conversation'", 'null': 'True', 'to': u"orm['activities.Conversation']"})
        },
        u'auth.group': {
