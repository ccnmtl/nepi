...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Day.explanation'
        db.alter_column(u'activities_day', 'explanation', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Day.explanation'
        db.alter_column(u'activities_day', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=255))
