...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdherenceCard'
        db.create_table(u'activities_adherencecard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('intro_text', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'activities', ['AdherenceCard'])


    def backwards(self, orm):
        # Deleting model 'AdherenceCard'
        db.delete_table(u'activities_adherencecard')
