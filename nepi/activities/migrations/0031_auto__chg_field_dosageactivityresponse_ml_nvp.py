...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DosageActivityResponse.ml_nvp'
        db.alter_column(u'activities_dosageactivityresponse', 'ml_nvp', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'DosageActivityResponse.ml_nvp'
        db.alter_column(u'activities_dosageactivityresponse', 'ml_nvp', self.gf('django.db.models.fields.IntegerField')())
