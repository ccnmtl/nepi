...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdherenceCard.quiz_class'
        db.add_column(u'activities_adherencecard', 'quiz_class',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdherenceCard.quiz_class'
        db.delete_column(u'activities_adherencecard', 'quiz_class')
