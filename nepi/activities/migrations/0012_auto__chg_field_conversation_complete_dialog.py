...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'activities_conversation', 'complete_dialog', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Conversation.complete_dialog'
        db.alter_column(u'activities_conversation', 'complete_dialog', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
