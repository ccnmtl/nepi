...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RetentionResponse'
        db.create_table(u'activities_retentionresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('retentionrate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.RetentionRateCard'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('cohort_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_cohort_click', null=True, to=orm['activities.ConvClick'])),
            ('start_date_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_start_date_click', null=True, to=orm['activities.ConvClick'])),
            ('eligible_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_eligible_click', null=True, to=orm['activities.ConvClick'])),
            ('delivery_date_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_delivery_date_click', null=True, to=orm['activities.ConvClick'])),
            ('dec_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_dec_click', null=True, to=orm['activities.ConvClick'])),
            ('jan_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_jan_click', null=True, to=orm['activities.ConvClick'])),
            ('feb_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_feb_click', null=True, to=orm['activities.ConvClick'])),
            ('mar_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_mar_click', null=True, to=orm['activities.ConvClick'])),
            ('apr_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_apr_click', null=True, to=orm['activities.ConvClick'])),
            ('may_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_may_click', null=True, to=orm['activities.ConvClick'])),
            ('jun_click', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retention_jun_click', null=True, to=orm['activities.ConvClick'])),
        ))
        db.send_create_signal(u'activities', ['RetentionResponse'])


    def backwards(self, orm):
        # Deleting model 'RetentionResponse'
        db.delete_table(u'activities_retentionresponse')
    ...
    models = {
        ...
        u'activities.retentionresponse': {
            ...
            'apr_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_apr_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'cohort_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_cohort_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'dec_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_dec_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'delivery_date_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_delivery_date_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'eligible_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_eligible_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'feb_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_feb_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jan_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_jan_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'jun_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_jun_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'mar_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_mar_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'may_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_may_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'retentionrate': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.RetentionRateCard']", 'null': 'True', 'blank': 'True'}),
            'start_date_click': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retention_start_date_click'", 'null': 'True', 'to': u"orm['activities.ConvClick']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        u'auth.group': {
