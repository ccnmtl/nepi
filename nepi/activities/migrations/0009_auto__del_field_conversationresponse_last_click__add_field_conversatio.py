...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConversationResponse.third_click'
        db.add_column(u'activities_conversationresponse', 'third_click',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'activities_conversationresponse', 'last_click',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='third_click', null=True, to=orm['activities.ConvClick'], blank=True),
                      keep_default=False)

        # Deleting field 'ConversationResponse.third_click'
        db.delete_column(u'activities_conversationresponse', 'third_click_id')
