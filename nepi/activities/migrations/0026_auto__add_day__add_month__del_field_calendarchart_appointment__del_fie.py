...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Day'
        db.create_table(u'activities_day', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('calendar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Month'])),
            ('number', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('explanation', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ))
        db.send_create_signal(u'activities', ['Day'])

        # Adding model 'Month'
        db.create_table(u'activities_month', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ))
        db.send_create_signal(u'activities', ['Month'])

        # Deleting field 'CalendarChart.appointment'
        db.delete_column(u'activities_calendarchart', 'appointment')

        # Deleting field 'CalendarChart.birth_date'
        db.delete_column(u'activities_calendarchart', 'birth_date')

        # Deleting field 'CalendarChart.num_days'
        db.delete_column(u'activities_calendarchart', 'num_days')

        # Adding field 'CalendarChart.month'
        db.add_column(u'activities_calendarchart', 'month',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['activities.Month']),
                      keep_default=False)

        # Adding field 'CalendarChart.correct_date'
        db.add_column(u'activities_calendarchart', 'correct_date',
    ...
    def backwards(self, orm):
        # Deleting model 'Day'
        db.delete_table(u'activities_day')

        # Deleting model 'Month'
        db.delete_table(u'activities_month')
        ...
        # Adding field 'CalendarChart.birth_date'
        db.add_column(u'activities_calendarchart', 'birth_date',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CalendarChart.num_days'
        db.add_column(u'activities_calendarchart', 'num_days',
                      self.gf('django.db.models.fields.IntegerField')(default=30),
                      keep_default=False)

        # Deleting field 'CalendarChart.month'
        db.delete_column(u'activities_calendarchart', 'month_id')

        # Deleting field 'CalendarChart.correct_date'
        db.delete_column(u'activities_calendarchart', 'correct_date')
