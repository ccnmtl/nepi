...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AggregateQuizScore'
        db.create_table(u'main_aggregatequizscore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quiz_class', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'main', ['AggregateQuizScore'])


    def backwards(self, orm):
        # Deleting model 'AggregateQuizScore'
        db.delete_table(u'main_aggregatequizscore')
