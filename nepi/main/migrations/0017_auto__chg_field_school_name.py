...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_school', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'School.name'
        db.alter_column(u'main_school', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
