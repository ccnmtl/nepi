...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_course', 'module_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagetree.Hierarchy'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.module'
        db.alter_column(u'main_course', 'module_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Module'], null=True))
