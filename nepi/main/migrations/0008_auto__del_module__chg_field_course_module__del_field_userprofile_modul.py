...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.module'
        db.alter_column(u'main_course',
                        'module_id',
                        self.gf('django.db.models.fields.related.ForeignKey')
                        (to=orm['pagetree.Hierarchy'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.module'
        db.alter_column(u'main_course', 'module_id',
                        self.gf('django.db.models.fields.related.ForeignKey')
                        (to=orm['main.Module'], null=True))
        # Adding field 'UserProfile.module'
        db.add_column(u'main_userprofile', 'module',
                      self.gf('django.db.models.fields.related.ForeignKey')
                      (default=None, to=orm['main.Module'],
    ...
    models = {
        ...
        u'main.course': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey',
                       [], {'to': u"orm['main.School']"}),
            'semester': ('django.db.models.fields.CharField',
                         [], {'max_length': '50', 'blank': 'True'}),
        ...
        u'main.pendingteachers': {
            ...
            u'id': ('django.db.models.fields.AutoField',
                    [], {'primary_key': 'True'}),
            'school': ('django.db.models.fields.related.ForeignKey',
                       [], {'default': 'None', 'to': u"orm['main.School']",
                            'null': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey',
                             [], {'related_name': "'pending_teachers'",
                                  'to': u"orm['main.UserProfile']"})
        },
        u'main.school': {
            'Meta': {'object_name': 'School'},
            'country': ('django.db.models.fields.related.ForeignKey',
                        [], {'default': 'None', 'to': u"orm['main.Country']",
                             'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField',
                    [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField',
        ...
        u'main.userprofile': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey',
                        [], {'default': 'None', 'to': u"orm['main.Country']",
                             'null': 'True', 'blank': 'True'}),
            'course': ('django.db.models.fields.related.ManyToManyField',
                       [], {'default': 'None', 'to': u"orm['main.Course']",
                            'null': 'True', 'symmetrical': 'False',
                            'blank': 'True'}),
            'icap_affil': ('django.db.models.fields.BooleanField',
                           [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField',
                    [], {'primary_key': 'True'}),
