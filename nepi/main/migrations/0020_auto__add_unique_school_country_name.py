...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'School', fields ['country', 'name']
        db.create_unique(u'main_school', ['country_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'School', fields ['country', 'name']
        db.delete_unique(u'main_school', ['country_id', 'name'])
