...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.school'
        db.alter_column(u'main_group', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.School']))

        # Changing field 'Group.creator'
        db.alter_column(u'main_group', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'PendingTeachers.school'
        db.alter_column(u'main_pendingteachers', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.School']))

    def backwards(self, orm):

        # Changing field 'Group.school'
        db.alter_column(u'main_group', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.School'], null=True))

        # Changing field 'Group.creator'
        db.alter_column(u'main_group', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PendingTeachers.school'
        db.alter_column(u'main_pendingteachers', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.School'], null=True))
    ...
    models = {
        ...
        u'main.group': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_by'", 'to': u"orm['auth.User']"}),
