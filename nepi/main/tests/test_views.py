...
from nepi.main.views import index, about, help_page, thank_you_reg, table_register
...
class BasicTest(TestCase):
    ...
    def test_registration_and_login(self):
        request = self.factory.post('/table_register/', {"username" : "new_student", "password1" : "new_student", 
            "password2" : "new_student", "email":"email@email.com", "first_name":"new_student", "last_name":"new_student",
            "country":"DZ", "profile_type":"ST", "is_teacher" : "ST"})
        response = table_register(request)
        self.assertEqual(response.status_code, 302)

    def test_client_registration_and_login(self):
        request = self.c.post('/table_register/', {"username" : "new_person", "password1" : "new_student", 
            "password2" : "new_student", "email":"email@email.com", "first_name":"new_student", "last_name":"new_student",
            "country":"DZ", "profile_type":"ST", "is_teacher" : "ST"})
