...
urlpatterns = patterns(
    ...
    (r'^en/', 'nepi.main.views.index'),
    (r'^fr/', 'nepi.main.views.index'),
    (r'^pr/', 'nepi.main.views.index'),
    (r'^modules/en/', 'nepi.main.views.index'),
    (r'^modules/fr/', 'nepi.main.views.index'),
    (r'^modules/pr/', 'nepi.main.views.index'),
